...
let currentDate = new Date();
 ...
 // declare this outside the function to keep track of selection
...
function renderCalendar(date) {
    ...
    console.log("Selected date (auto-fetch):", selectedDate);
    }

    // Add blank slots for days before the first day of the month
...
async function fetchEntriesFromFirestoreForDate(dateStr) {
    ...
    try {
        // ✅ Correct way to get subcollection reference
...
function start(){window.location.href = `mysteps://start-tracking?msg=hi`;}
